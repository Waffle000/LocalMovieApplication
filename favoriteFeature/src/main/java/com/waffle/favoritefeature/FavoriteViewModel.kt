...
class FavoriteViewModel(private val useCase: PopularUseCase) : ViewModel() {

    fun getPopularFavorite() : LiveData<Resource<List<Popular>>> {
        return useCase.getPopularFavorite().asLiveData()
    }
